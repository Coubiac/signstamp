...
export const de: Translations = {
  ...
  templates: "Vorlagen",
  templates_save_placeholder: "Vorlagenname…",
  templates_save_button: "Speichern",
  templates_save_disabled: "Öffne ein PDF und platziere mindestens ein Overlay.",
  templates_empty: "Noch keine Vorlagen. Platziere deine Overlays, benenne die Vorlage oben und klicke Speichern.",
  templates_apply: "Anwenden",
  templates_delete: "Vorlage löschen",
  templates_rename_hint: "Doppelklick zum Umbenennen",
