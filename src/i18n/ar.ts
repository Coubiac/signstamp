...
export const ar: Translations = {
  ...
  templates: "القوالب",
  templates_save_placeholder: "اسم القالب…",
  templates_save_button: "حفظ",
  templates_save_disabled: "افتح PDF وضع على الأقل تراكباً واحداً.",
  templates_empty: "لا توجد قوالب. ضع التراكبات، سمّ القالب في الأعلى، ثم اضغط حفظ.",
  templates_apply: "تطبيق",
  templates_delete: "حذف القالب",
  templates_rename_hint: "انقر مرتين لإعادة التسمية",
  signatures: "التواقيع",
