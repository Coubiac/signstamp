...
export const ja: Translations = {
  ...
  templates: "テンプレート",
  templates_save_placeholder: "テンプレート名…",
  templates_save_button: "保存",
  templates_save_disabled: "PDF を開き、オーバーレイを少なくとも一つ配置してください。",
  templates_empty: "テンプレートはまだありません。オーバーレイを配置し、上で名前を入力して保存をクリックしてください。",
  templates_apply: "適用",
  templates_delete: "テンプレートを削除",
  templates_rename_hint: "ダブルクリックで名前変更",
  signatures: "署名",
