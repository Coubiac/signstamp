...
export const ja: Translations = {
  ...
  autofill: "自動入力",
  autofill_title: "自動入力プレビュー",
  autofill_text_fields: "個のテキストフィールドが入力されます",
  autofill_signatures: "個の署名が配置されます",
  autofill_paraph: "イニシャルを全ページに追加",
  autofill_unmatched: "個のフィールドは入力できません",
  autofill_apply: "適用",
  autofill_no_matches: "フィールドは見つかりましたが一致するものがありません — プロフィールを確認してください。",
  autofill_flat_pdf: "この PDF には入力可能なフォームフィールドがありません — フラットな文書です。手動ツールを使用してください。",
  autofill_paraph_medium: "イニシャルゾーンの候補を低い信頼度で検出しました — 必要に応じて手動で配置してください。",
  signatures: "署名",
