...
export const fr: Translations = {
  ...
  templates: "Templates",
  templates_save_placeholder: "Nom du template…",
  templates_save_button: "Enregistrer",
  templates_save_disabled: "Ouvre un PDF et place au moins un overlay.",
  templates_empty: "Aucun template. Pose tes overlays, donne un nom au template ci-dessus, puis clique Enregistrer.",
  templates_apply: "Appliquer",
  templates_delete: "Supprimer le template",
  templates_rename_hint: "Double-clic pour renommer",
