...
export const en = {
  ...
  templates: "Templates",
  templates_save_placeholder: "Template name…",
  templates_save_button: "Save",
  templates_save_disabled: "Open a PDF and place at least one overlay first.",
  templates_empty: "No templates yet. Place your overlays, name your template above, and click Save.",
  templates_apply: "Apply",
  templates_delete: "Delete template",
  templates_rename_hint: "Double-click to rename",
