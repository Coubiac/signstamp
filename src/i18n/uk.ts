...
export const uk: Translations = {
  ...
  templates: "Шаблони",
  templates_save_placeholder: "Назва шаблону…",
  templates_save_button: "Зберегти",
  templates_save_disabled: "Відкрий PDF і додай хоча б один елемент.",
  templates_empty: "Шаблонів немає. Додай елементи, вкажи назву вище та натисни Зберегти.",
  templates_apply: "Застосувати",
  templates_delete: "Видалити шаблон",
  templates_rename_hint: "Подвійний клік для перейменування",
  signatures: "Підписи",
